...
const rectangle1 = getRectangleString(6, 4);
console.log(rectangle1);

const rectangle2 = getRectangleString(2, 2);
console.log(rectangle2);

const rectangle3 = getRectangleString(12, 3);
...
function encodeToRot13(str) {
  return str.replace([A-Za-z]/g, function(char){
    ...
    String.fromCharCode((char.charCodeAt(0) - shift + 13) % 26 + shift)
  })
}
